...
namespace nDash {
    class ACPlugin : public GameServer::GamePlugin {
        public:
            ACPLUGIN_API virtual const string &pluginInfo() const {
                static string name("Assetto Corsa UDP Interface");
                return name;
            }

            ACPLUGIN_API virtual ~ACPlugin() {
                closeConnection();
            }

            ACPLUGIN_API virtual void closeConnection() {
                handshake.dismiss();
            ...
            ACPLUGIN_API virtual int initGame() {
#if defined(NDASH_WIN32)
                WSADATA WSA;
            ...
            ACPLUGIN_API virtual int updateGame(void) {
        ...
        private:
            ...
            struct handshaker handshake;
            struct handshake_response hs_response;
            struct rtcar_info car_info;
    };
